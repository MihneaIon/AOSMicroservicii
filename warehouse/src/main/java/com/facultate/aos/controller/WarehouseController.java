...
import com.facultate.aos.service.WarehouseService;
...
public class WarehouseController {
    ...
    @RequestMapping(path = "/{warehouseId}/items/{itemId}", method = RequestMethod.GET)
    public ResponseEntity<List<Item>> getItem(@PathVariable(name = "warehouseId") long warehouseId, @PathVariable(name = "itemId") Long itemId) {
        return new ResponseEntity<>(warehouseService.getAllItems(warehouseId), HttpStatus.OK);
    }
    ...
    @RequestMapping(path = "/searchForProduct/{warehouseId}/{itemId}", method = RequestMethod.GET)
    public  ResponseEntity<Item> getItemFromWarehouse(@PathVariable(name = "warehouseId")long warehouseId,
                                                      @PathVariable(name = "itemId") long itemId)
    {
        return new ResponseEntity<>(warehouseService.getItem(warehouseId,itemId), HttpStatus.OK);
    }
}
